        ...
        <Container>
            ...
            <Content contentContainerStyle={[styles.bgFullWidth, styles.position_R]}>
                ...
                {inChat && inChat.length !== 0 ?
                    ...
                    <ScrollView style={[styles.Width_100, { height: 400 }]} ref={scrollViewRef} onContentSizeChange={(contentWidth, contentHeight) => { scrollViewRef.current.scrollToEnd({ animated: true }) }}>
                                                    ...
                                                    <View style={[styles.Width_100, styles.rowIng, styles.overHidden, styles.marginVertical_10]}>
                                                        <View style={[styles.flex_85]}>
                                                            <View style={[styles.paddingVertical_10, styles.rowLeft, { flexDirection: 'column' }, styles.paddingHorizontal_20, styles.Radius_30, styles.bg_default, { borderTopRightRadius: 0 },]}>
                                                                <Text style={[styles.FairuzBold, styles.text_White, styles.textSize_14, styles.textDir]}>
                                                                    {chat.message}
                                                                </Text>
                                                                <View style={[styles.rowLeft]}>
                                                                    <Text style={[styles.text_light_gray, styles.FairuzBold, styles.textSize_12, styles.textDir]}>{chat.date}</Text>
                                                                </View>
                                                            </View>
                                                        </View>
                                                        <View style={[styles.flex_15, styles.flexCenter]}>
                                                            <Image
                                                                style={[styles.width_50, styles.height_50, styles.Radius_30, styles.Border, styles.border_orange]}
                                                                source={{ uri: image }}
                                                            />
                                                        </View>
                                                    </View>
                                                        ...
                                                        <View style={[styles.Width_100]}>
                                                            <View style={[styles.paddingVertical_10, styles.rowRight, { flexDirection: 'column' }, styles.paddingHorizontal_20, styles.Radius_30, setErrFun ? styles.bg_orange : styles.bg_red, { borderBottomLeftRadius: 0 }]}>
                                                                ...
                                                                <View style={[styles.rowLeft]}>
                                                                    ...
                                                                    <Text style={[styles.text_White, styles.FairuzBold, styles.textSize_12, styles.textDir]}>{chat.date}</Text>
                                                                </View>
                                                            </View>
                                                        </View>
                                                    </View>
            ...
            <View style={[styles.Width_100, styles.rowGroup, styles.paddingHorizontal_5, styles.bg_White, styles.paddingVertical_10,]}>
                ...
                <View style={[styles.flex_15, styles.flexCenter]}>
                    <TouchableOpacity
                        ...
                        <Icon style={[styles.text_White, styles.textSize_20]} type="Ionicons" name='paper-plane' />
                    </TouchableOpacity>
                </View>
            </View>
