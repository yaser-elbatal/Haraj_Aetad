...
function Chat({ navigation }) {
    ...
    return (
        <Container>
            ...
            <Content contentContainerStyle={[styles.bgFullWidth, styles.position_R, styles.paddingBottom_60, styles.bg_dash]}>
                                ...
                                return (
                                    <View style={[styles.Width_100, styles.overHidden]}>
                                        <Animatable.View animation="fadeInUp" easing="ease-out" delay={500} style={[styles.Width_100]}>
                                            <TouchableOpacity onPress={() => navigation.push('chatRoom', { userId: chat.other.id, advId: chat.ad_id, image: chat.other.avatar, name: chat.other.name })}
