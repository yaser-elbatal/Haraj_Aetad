...
function Register({ navigation, route }) {
    ...
    function renderLoader() {
        if (loader) {
            return (
                <View style={[styles.position_A, styles.flexCenter, styles.bg_White, styles.right_0, styles.top_0, styles.Width_100, styles.height_full, styles.bgFullWidth,{ zIndex: 9999 }]}>
                    <ActivityIndicator animating={true} size="large" color="#444" />
