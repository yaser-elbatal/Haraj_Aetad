    ...
    return (
        <Container>
            ...
            <Content contentContainerStyle={styles.bgFullWidth}>
                ...
                <View style={[ styles.paddingVertical_10 ]}>
                    {
                        dataInfo ?
                            <View>
                                <View style={[ styles.Width_95, styles.height_230, styles.border_dash, styles.Border, styles.flexCenter, styles.marginTop_15, styles.position_R  ]}>
                                    ...
                                    <View style={[ styles.rowGroup, styles.Width_100, styles.bottom_0, styles.right_0, styles.position_A, styles.overlay_black, styles.paddingVertical_5, styles.paddingHorizontal_5 ]}>
                                        {
                                            authID !== dataInfo.ad.user.id ?
                                                <TouchableOpacity onPress={() => navigation.navigate('profileUserAdv', { provider_id : dataInfo.ad.user.id, blogId : blogId, id : dataInfo.ad.user.id, rate : dataInfo.ad.user.rate })}>
                                                    <View style={[ styles.rowIng ]}>
                                                        <Image
                                                            ...
                                                            resizeMode={'contain'}
                                                        />
                                                        <Text style={[ styles.FairuzBlack, styles.text_White, styles.textSize_14, styles.marginHorizontal_5 ]}>{ dataInfo.ad.user.name }</Text>
                                                    </View>
                                                </TouchableOpacity>
                                                :
                                                <View/>
                                        ...
                                        <View style={[ styles.rowIng ]}>
                                            ...
                                            <Text style={[ styles.FairuzBlack, styles.text_White, styles.textSize_14, styles.marginHorizontal_5 ]}>
                                ...
                                {
                                    authID !== dataInfo.ad.user.id ?
                                        <View style={[ styles.rowCenter, styles.Width_100, styles.marginVertical_10, styles.marginTop_20 ,styles.paddingHorizontal_10 ]}>

                                            {
                                                dataInfo.ad.is_phone === true ?
                                                    <TouchableOpacity
                                                        style       = {[ styles.flex_33, styles.height_50, styles.flexCenter, styles.paddingHorizontal_5, { backgroundColor : '#00AFF0'} ]}
...

                                            {
                                                dataInfo.ad.is_phone === true ?
                                                    <TouchableOpacity
                                                        style       = {[ styles.flex_33, styles.height_50, styles.flexCenter, styles.paddingHorizontal_5, { backgroundColor : '#25D366'} ]}
...

                                            {
                                                dataInfo.ad.is_chat === true && auth !== null ?
                                                    <TouchableOpacity
                                                        style       = {[ styles.flex_33, styles.height_50, styles.flexCenter, styles.paddingHorizontal_5, { backgroundColor : '#dd4b39'} ]}
                                                        onPress     = {() => navigation.navigate('chatRoom', { userId : dataInfo.ad.user.id, advId : blogId, image : dataInfo.ad.user.avatar, name : dataInfo.ad.user.name })}
                                                    >
                                                        <Image
                                                            style={[styles.width_20, styles.width_20]}
                                ...
                                <View style={[ styles.marginVertical_10, styles.bg_wight, styles.paddingHorizontal_20, styles.paddingVertical_10, styles.Width_100, styles.SelfCenter ]}>
                                    ...
                                    >
                                        <Text style={[ styles.FairuzBlack, styles.text_black, styles.textSize_14, styles.textDecoration ]}>
                                            { i18n.t('showmap') }
                                        </Text>
                                    </TouchableOpacity>
