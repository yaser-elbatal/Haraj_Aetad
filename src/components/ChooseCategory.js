                ...
                <View style={[ styles.rowGroup, styles.paddingHorizontal_5, styles.paddingVertical_10 ]}>

                    {
                        categories.map((cate) => {
                                return (
                                    <TouchableOpacity
                                        onPress={() => clickCategory( cate.has_subs, { name : cate.name, id : cate.id, count : cate.has_subs, features : cate.features } )}                                        style={[ styles.overHidden, styles.flex_50, styles.paddingHorizontal_10, styles.marginVertical_5 ]}>
                                        <Animatable.View animation="zoomIn" easing="ease-out" delay={900} style={[styles.Width_100, styles.paddingVertical_10]}>
                                            <View style={[ styles.boxShadow, styles.bg_White, styles.marginHorizontal_5, styles.flexCenter, styles.Width_100, styles.Radius_10 ]}>
